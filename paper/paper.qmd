...
# Load the cleaned dataset for use in this section
...
### 2.1 Scope and Relevance of the Dataset
...
#### 2.3.1 Polling Organizations and Methodologies
...
#### 2.4.1 Initial Data Cleaning and Transformations
...
```{r}
# Visualization: Distribution of Sample Sizes
library(ggplot2)
...
### 2.5 Key Variables and Derived Features

#### 2.5.1 Description of Key Variables
...
#### 2.5.2 Variable Transformations and Feature Engineering
...
### 2.6 Filtering Criteria and Data Selection

#### 2.6.1 Timeframe Filtering
...
#### 2.6.2 Pollster Reliability Filtering
...
### 2.7 Recency and Its Importance in Poll Weighting

#### 2.7.1 Calculating Recency
...
#### 2.7.2 Application of Recency Weights
...
### 2.8 Summary and Visualization of Cleaned Data

#### 2.8.1 Cleaned Dataset Overview
