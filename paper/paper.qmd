...
By measuring these things, we aimed to see how each factor might influence voter support in the polls. This helped us build a model to predict how the election might turn out based on the polling data we collected.
